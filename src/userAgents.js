const userAgents = ["Mozilla/5.0 CK={} (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko",
...
function getRandomUserAgent(){
    const randomElement = userAgents[Math.floor(Math.random() * userAgents.length)];
